...
postDeps = {
    ...
    "subfinder": "go install -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder@latest  && sudo cp ~/go/bin/subfinder /usr/local/bin",
    "hakrawler": "go install -v github.com/hakluke/hakrawler@latest && sudo cp ~/go/bin/hakrawler /usr/local/bin",
